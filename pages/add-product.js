  ...
  return (
        <div className={s.containerForm}>
            ...
            <div className={s.containerViewProduct}>
                <h3 className="w-full text-center -mt-5 text-xl font-montserrat font-bold underline mb-4">
                    Producto
                </h3>
                {previewImg
                  ? (
                  ...
                  : (
                    <div className={s.noHasImage}>
                        <h3
                            className={`${s.noHasImage_title} -mt-8 uppercase font-montserrat font-bold underline underline-offset-8`}
                        >
                            Ojotas artesanales
                        </h3>
                        <p className="font-montserrat flex items-center gap-3">
                            Cargar producto <PlusIcon />
                        </p>
                    </div>
                    )}
                <p className="w-full text-center text-lg font-montserrat">
                    Ojotas artesanales
                </p>
            </div>
            ...
            <div className="w-full">
                <h1 className="text-black font-montserrat sm:whitespace-nowrap mb-4 font-medium text-center text-xl">
                ...
                >
                    ...
                    <div className="flex gap-2">
                        {img.length > 0 &&
                            img.map((ph) => (
                                <div
                                    key={ph}
                                    className="flex flex-col justify-start items-center w-max gap-2"
                                >
                                    <Image
                                        onClick={() => setPreviewImg(ph)}
                                        width={100}
                                        height={100}
                                        alt="Foto de producto"
                                        objectFit="cover"
                    ...
                    <div className="flex relative items-center">
                        <label
                            ...
                            className={`${s.labelForInputUploadImage}`}
                        >
                            {!img.length && (
                                <PlusIcon color="rgb(138, 138, 138)" />
                            )}{' '}
                            {progress
                              ? 'Subiendo...'
                              : 'Formato en JPG, JPEG, PNG, WEBP'}
                        </label>
                        <input
                            type="file"
                            id="inputFile"
                    ...
                    <div className="flex flex-col gap-4 mb-4 w-full">
                        {Object.keys(product.stock).map((talle) => (
                            ...
                            >
                                <div
                                    className={
                                        'flex w-[3.3rem] bg-white border p-1 items-center justify-between my-2'
                                    }
                                >
                    ...
                    <button
                        type="submit"
                        className="bg-black py-4 capitalize px-1 hover:bg-slate-600 transition-all duration-300 text-white font-montserrat text-md"
                    >
                        {Object.keys(edit).length > 0 ? 'EDITAR' : 'AGREGAR'}{' '}
                        PRODUCTO
                    </button>
                </form>
            </div>
